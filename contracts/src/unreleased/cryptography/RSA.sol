// From https://github.com/OpenZeppelin/openzeppelin-contracts/blob/c3f8b760ad9d0431f33e8303658ccbdcc1610f24/contracts/utils/cryptography/RSA.sol
    ...
    function pkcs1(
        ...
        unchecked {
            ...
            if (bytes1(_unsafeReadBytes32(buffer, length - 50)) == 0x31) {
                ...
                bytes1(_unsafeReadBytes32(buffer, length - 48)) == 0x2F
            ) {
                offset = 0x32;
